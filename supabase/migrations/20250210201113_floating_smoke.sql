/*
  # Optimize duplicate contacts removal
  
  1. Changes
    - Added batching to prevent timeouts
    - Added progress tracking
    - Improved performance with temporary tables
...
BEGIN
  ...
  -- Process in batches
  WHILE EXISTS (SELECT 1 FROM duplicate_numbers WHERE NOT processed) LOOP
    FOR r IN (
      SELECT phone_number 
      ...
      BEGIN
        ...
        RAISE NOTICE 'Progress: % of % phone numbers processed', processed, total_duplicates;
